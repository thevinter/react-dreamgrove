...
import { allBlogs, allAuthors, allDungeons } from 'contentlayer/generated'
import type { Authors, Blog, Dungeons } from 'contentlayer/generated'
...
export default async function Page({ params }: { params: { slug: string[] } }) {
  const slug = decodeURI(params.slug.join('/'))
  const sortedCoreContents = allCoreContent(sortPosts(allDungeons))
